...
namespace Admin
{
    public partial class FarmerFruit : Form
    {
        SqlConnection con;
        ...
        private void DeleteUFruitTable()
        {
            try
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("DELETE FROM UFruit", con);
                cmd.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
        ...
        private void LoadUFruitTable()
        {
            try
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("SELECT * FROM UFruit", con);
        ...
        private void SellProduct(string productName, decimal price, int quantity)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO UFruit ([Product Name], [Product Quantity], [Product Price], [Total Price]) VALUES (@Name, @Quantity, @Price, @Total)", con);
        ...
        private void FarmerFruit_Load(object sender, EventArgs e)
        {
            DeleteUFruitTable();
            LoadUFruitTable();
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Watermelon", price, quantity);
            else
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Banana", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Strawberry", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Mango", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Orange", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Lychee", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Apple", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Pomegranate", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Guava", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void CalculateTotalAmount()
        {
            ...
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("SELECT SUM(CAST([Total Price] AS DECIMAL(10,2))) FROM UFruit", con);
