...
namespace Admin
{
    public partial class FarmerFish : Form
    {
        SqlConnection con;
        ...
        private void LoadUFishTable()
        {
            try
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("SELECT * FROM UFish", con);
        ...
        private void CalculateTotalAmount()
        {
            ...
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("SELECT SUM(CAST([Total Price] AS DECIMAL(10,2))) FROM UFish", con);
        ...
        private void DeleteUFishTable()
        {
            try
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("DELETE FROM UFish", con);
                cmd.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
        ...
        private void SellProduct(string productName, decimal price, int quantity)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO UFish ([Product Name], [Product Quantity], [Product Price], [Total Price]) VALUES (@Name, @Quantity, @Price, @Total)", con);
        ...
        private void FarmerFish_Load(object sender, EventArgs e)
        {
            DeleteUFishTable();
            LoadUFishTable();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Kural", price, quantity);
            else
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Prawn", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Pangasius", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Wallago", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Hilsa", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Mrigal Carp", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("St. Peter's", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Rui", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
                SellProduct("Tuna", price, quantity);
            else
                MessageBox.Show("Please select a valid quantity.");
        }
