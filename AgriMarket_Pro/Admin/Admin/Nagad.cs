...
namespace Admin
{
    public partial class Nagad : Form
    {
        ...
        public Nagad(Form sourceForm, decimal totalAmount)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)//Payment
        {
            ...
            // Insert the data into the UpAid table with 'Nagad' in the From column
            try
            {
        ...
        private void InsertIntoUpaid(string phoneNumber, string amount)
        {
            ...
            {
                con.Open();
                // Insert into Upaid table with "From" set to "Nagad"
                string query = "INSERT INTO [Upaid] ([Ph_Num/U_ID/Acc_Num], [Amount], [From]) VALUES (@Phone, @Amount, 'Nagad')";
        ...
        private void Nagad_Load(object sender, EventArgs e)
        {
