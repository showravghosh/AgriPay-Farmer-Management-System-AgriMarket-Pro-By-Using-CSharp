...
namespace Admin
{
    public partial class UserFruit : Form
    {
        SqlConnection con;
        ...
        private void DeleteFruitTable()
        {
            try
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("DELETE FROM Fruit", con);
                cmd.ExecuteNonQuery();
                con.Close();
            }
            catch (Exception ex)
        ...
        private void CalculateTotalAmount()
        {
            ...
            {
                dbcon();
                SqlCommand cmd = new SqlCommand("SELECT SUM(CAST([Total Price] AS DECIMAL(10,2))) FROM Fruit", con);
        ...
        private void AddProductToDatabase(string productName, decimal price, int quantity)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO Fruit ([Product Name], [Product Quantity], [Product Price], [Total Price]) VALUES (@Name, @Quantity, @Price, @Total)", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Banana", price, quantity);
            }
            else
            {
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Strawberry", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Watermelon", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Mango", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Orange", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Lychee", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Apple", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Pomegranate", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (quantity > 0)
            {
                AddProductToDatabase("Guava", price, quantity);
            }
            else
            {
                MessageBox.Show("Please select a valid quantity.");
        ...
        private void UserFruit_Load(object sender, EventArgs e)
        {
            DeleteFruitTable();
            LoadFruitTable();
